  ...
  const submitHandler = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        `${server}/users/new`,
        // 'http://apis.uplive.booringcodes.in/api/register/manual',
        {
          name,
          email,
          password,
  ...
  return (
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-2 my-32">
        <div className="flex items-center justify-center px-12 md:px-8 md:py-24 md:ml-36">
        ...
        <div className="h-full w-full lg:flex hidden">
          <img
            className="mx-auto h-4/5 w-4/5 rounded-md object-cover mt-20 mr-40"

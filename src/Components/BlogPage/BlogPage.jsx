...
function BlogPage() {
  return (
    <>
       <div className="mt-10 hidden px-48 w-full flex-col justify-between space-y-4 md:flex md:flex-row">
      ...
      <div className="grid gap-6 gap-y-10 py-6 md:grid-cols-2 lg:grid-cols-3 md:p-20 md:py-6 md:px-48 px-6">

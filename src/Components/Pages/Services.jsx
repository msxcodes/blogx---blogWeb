  ...
  return (
    ...
    <div className='px-4 py-32 bg-black mx-auto'>
      <div className='text-white text-center'>
        <h1 className='text-5xl lg:text-7xl leading-snug font-bold mb-4'>Our Service Page</h1>
    ...
    <h1 className='text-7xl font-bold my-32 text-center'>This Service Page</h1>
    </>
  )
}
